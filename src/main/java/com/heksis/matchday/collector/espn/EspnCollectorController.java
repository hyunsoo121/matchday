...
@RestController
@RequestMapping("/api/v1/admin/collector/espn")
@RequiredArgsConstructor
public class EspnCollectorController {
  ...
  public ApiResponse<String> sync(
    ...
    espnCollector.syncAll(syncFrom, syncTo);
    return ApiResponse.ok("ESPN 동기화 완료: " + syncFrom + " ~ " + syncTo);
  }
}
